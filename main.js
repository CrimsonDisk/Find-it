...
function showHintQuestion() {
    ...
    currentMathAnswer = currentMathQuestion.answer;
    mathQuestionText.textContent = currentMathQuestion.question;
...
/**
 * Check math answer and reveal hint
 */
